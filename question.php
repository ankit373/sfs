...
if(isset($_POST['add'])){
	$que = $_POST['que'];
	$sql1 = mysqli_query($db_handle,"ALTER TABLE `cm_feed` ADD `$que` INT(1) NOT NULL;");
	$sql2 = mysqli_query($db_handle,"ALTER TABLE `if_feed` ADD `$que` INT(1) NOT NULL;");
	$sql = mysqli_query($db_handle,"INSERT INTO ques(question) VALUES('$que')");
	if($sql && $sql1 && $sql2)
	{
		$msg = "Added";
	}
