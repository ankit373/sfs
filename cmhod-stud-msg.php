...
<?php
	if(isset($_POST['year']))
	{
		...
		$msg = array();
		$i=0;
		$res = mysqli_query($db_handle,"SELECT message FROM `cm_feed` WHERE message!='' AND year='$year'");
		if(!$res){
...
<input type="button"  onClick="printDiv('print-content')" class="logout" value="Print Result!"/>
