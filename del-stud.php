...
$user = $_POST['user'];
$res = mysqli_query($db_handle,"SELECT * FROM users WHERE user='$user'");
...
if(mysqli_num_rows($res)<1)
{
	...
	$uid = $row['u_id'];
	if(mysqli_query($db_handle,"DELETE FROM users WHERE user='$user'") && mysqli_query($db_handle,"DELETE FROM `$feed` WHERE u_id='$uid'") or die()){
...
<li><a href="#">Add Student</a>
	<ul>
			<li><a href="add-cm.php?key=CM">CM</a></li>
			<li><a href="add-cm.php?key=IF">IF</a></li>
 </ul>
</li>
<li><a  href="del-stud.php">Delete Student</a>
<ul>
		<li><a href="del-stud.php?key=CM">CM</a></li>
		<li><a href="del-stud.php?key=IF">IF</a></li>
</ul>
</li>
<li><a href="#">See Result</a>
<ul>
	<li><a href="result.php?key=CM">CM</a></li>
	<li><a href="result.php?key=IF">IF</a></li>
</ul>
</li>
<li><a  href="#">Students Messages</a>
	<ul>
		<li><a href="msg.php?key=CM">CM</a></li>
		<li><a href="msg.php?key=IF">IF</a></li>
	</ul>
</li>
...
<ul>
	<li><a href="cm-subject.php">CM</a></li>
	<li><a href="if-subject.php">IF</a></li>
</ul>
</li>
<li><a href="#">Profile</a>
<ul>
...
<tr>
	<th>No</th>
	<th align="left">Enrollment Number</th>
	<th>Action</th>
</tr>
<?php
		...
		while ($db_field = mysqli_fetch_assoc($result))
		{
			...
			$j = $i + 1;
			print("<td align='center' width = '40px><form action='del-stud.php?key=$branch' method='POST'><input type='hidden' name='user' value=".$user."><input type='submit' name='submit' value='Delete'></form></tr>");
			$i = $i + 1;
		}
?>
</table>
